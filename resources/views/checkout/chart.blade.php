...
@section('content')
    ...
    <div class="section-container" id="checkout-cart">
        ...
        <div class="container">
            <!-- BEGIN checkout -->
            <div class="checkout">
                <form action="{{('checkoutInfo')}}" method="GET" name="form_checkout">
                    ...
                    <div class="checkout-footer d-flex">
                        ...
                        <button type="submit" class="btn btn-inverse btn-lg btn-theme w-250px">CHECKOUT</button>
                    </div>
                    <!-- END checkout-footer -->
                </form>
            </div>
