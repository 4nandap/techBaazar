    ...
    <!-- BEGIN #checkout-info -->
		<div class="section-container" id="checkout-info">
			...
			<div class="container">
				<!-- BEGIN checkout -->
				<div class="checkout">
					<form action="{{('checkoutPayment')}}" method="GET" name="form_shipping" class="form-horizontal">
						...
						<div class="checkout-footer d-flex">
							<a href="{{('checkoutChart')}}" class="btn btn-white btn-theme me-auto">BACK</a>
							<button type="submit" class="btn btn-inverse btn-theme ms-10px">CONTINUE</button>
						</div>
						<!-- END checkout-footer -->
					</form>
				</div>
