					...
					<div class="product-detail">
						...
						<div class="product-info">
							...
							<div class="product-info-header">
								<h1 class="product-title"><span class="badge bg-primary">35% OFF</span> Apple iPhone 6S Plus (16GB) Silver - #89270182 </h1>
							...
							<div class="product-purchase-container">
								<div class="product-discount">
									<span class="discount">Rp 5.999.000</span>
								</div>
								<div class="product-price">
									<div class="price">Rp 3.899.350</div>
								</div>
								<a href="{{('checkoutChart')}}" class="btn btn-inverse btn-theme btn-lg w-200px">ADD TO CART</a>
							</div>
